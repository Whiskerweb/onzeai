...
const testimonials = [
  ...
  {
    plan: "Squad · 3 agents · 6 mois",
    title: "Le combiné Vlachance + Hans m'a sauvé",
    body: "J'ai compris que le vrai foot c'est les xG, pas l'instinct. Les premiers mois j'ai picolé avec mes potes ce que j'aurais perdu sinon.",
    name: "Sébastien",
    role: "28 · Lyon",
  },
  {
    plan: "Dembefric · L1 · Solo · 8 mois",
  ...
  {
    plan: "All Access · 5 agents · 3 mois",
    title: "Cinq agents, cinq perspectives",
    body: "Je décide en ayant tous les angles. Je gagne pas tout le temps mais je perds bien moins souvent. C'est ça qui change tout au final.",
    name: "Théo",
    role: "24 · Lille",
  },
  {
    plan: "Jack · PL · Solo · 5 mois",
    title: "Jack me parle PL comme un éditeur d'Opta",
    body: "Je suis le seul de mes potes qui gagne sur la PL. Le fait de pouvoir lui poser des questions sur Telegram, ça change tout.",
    name: "Camille",
    role: "27 · Bordeaux",
  },
  {
    plan: "Squad · 3 agents · 9 mois",
