...
const PLANS: PlanSpec[] = [
  {
    onzeId: "solo",
    name: "Onze.ai · Solo",
    description: "1 coach IA. Tous ses paris sur Telegram. 3 messages chat / jour.",
    monthlyEUR: 14.9,
  ...
  },
  {
    onzeId: "squad",
    name: "Onze.ai · Squad",
    description: "3 coachs IA. Tous leurs paris sur Telegram. 20 messages chat / jour.",
    monthlyEUR: 29.9,
  ...
  },
  {
    ...
    description: "Les 5 coachs. Tous leurs paris. Chat illimité 24/7.",
    monthlyEUR: 49.9,
